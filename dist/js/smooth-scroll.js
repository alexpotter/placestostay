...
(function (root, factory) {
    ...
    var escapeCharacters = function ( id ) {
        ...
        while (++index < length) {
            ...
            // Note: thereÃ¢â‚¬â„¢s no need to special-case astral symbols, surrogate
            ...
            // (U+0030 to U+0039), [Ã¢â‚¬Â¦]
            (index === 0 && codeUnit >= 0x0030 && codeUnit <= 0x0039) ||
            // If the character is the second character and is in the range [0-9]
            // (U+0030 to U+0039) and the first character is a `-` (U+002D), [Ã¢â‚¬Â¦]
            (
                index === 1 &&
            ...
            // U+005A), or [a-z] (U+0061 to U+007A), [Ã¢â‚¬Â¦]
            if (
                codeUnit >= 0x0080 ||
                codeUnit === 0x002D ||
                codeUnit === 0x005F ||
